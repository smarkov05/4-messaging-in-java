...
public class KafkaEventConsumerConfig {
    public static final String EVENT_REQUEST_CONSUMER_GROUP_ID = "event.request.group";
    ...
    private Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, EVENT_REQUEST_CONSUMER_GROUP_ID);
